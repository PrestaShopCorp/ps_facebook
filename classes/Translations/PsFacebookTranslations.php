        ...
        $translations[$locale] = [
            ...
            'configuration' => [
                ...
                'messages' => [
                    ...
                    'psEventBusUpgradeNeededWarning' => $this->module->l("The version of the module PrestaShop Event Bus running on this shop (v{psEventBusVersion}) is older than the minimum required v{requiredPsEventBusVersion}.\n\nYou may use PrestaShop Facebook but some features (i.e product synchronization) won't be available until you upgrade PrestaShop EventBus.", 'PsFacebookTranslations'),
                    'psEventBusUpgradeButton' => $this->module->l('Upgrade PrestaShop EventBus', 'PsFacebookTranslations'),
                    'psEventBusUpgradeDone' => $this->module->l('PrestaShop EventBus has been successfully upgraded.', 'PsFacebookTranslations'),
                ],
                'facebook' => [
