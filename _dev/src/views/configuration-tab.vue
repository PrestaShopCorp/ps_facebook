      ...
      <template v-else>
        ...
        >
          <div
            ...
            class="refocus"
          >
            <i class="material-icons material-icons-round fixed-size-large mb-2">warning</i>
          ...
          >
            ...
            <p v-if="exchangeTokensTryAgain">
              <i class="material-icons material-icons-round float-left fixed-size-big">warning</i>
